...
function onClickEdit(unit_id) {
    // Open edit device window
}

function onClickDelete(unit_id, unit_name) {
    //Are you sure you want to delete network No. ""?
    unit_name = unit_name === null? "" : unit_name;
    if (confirm("Вы уверены, что хотите удалить устройство " + unit_name + "?")) {
        // Send delete querry
    }
}
      ...
      <article class="widget">
            <div class="widget__controller">
                  ...
                  <div class="buttons">
                        ...
                        <button class="button button--edit" @click="onClickEdit(unit.id)">
