...
<template>
      ...
      <aside v-else class="sidebar mobile">         
            <div class="top">
                        <div class="logo-container">
                              <RouterLink to="/">
                                    <MqResponsive group>
            ...
            <div class="bottom">
                  <div class="bottom__middleground">
...
<style scoped> 
      ...
      @media(max-width: 767px){
            ...
            /* Отображате стили только для верхней полоски */
