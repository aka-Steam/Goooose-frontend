        ...
        <section class="dashboard-content">
            ...
            <div class="devices-space">
                <div v-if="DEVICES != null" v-for="(device, index) in DEVICES.data" :key="device.id">
                    <div class="device" @click="openItems[index] = !openItems[index]">{{ index + 1 }}&emsp;|&emsp;{{ "ID-" +
                        device.id }}
                        &emsp;|&emsp;&emsp;&emsp; {{
                            device.name }}
                        &emsp;&emsp;&emsp;| &emsp;&emsp;
                        <Tooltip :text="device.description" class="button button--info">
...
.button--info:hover {
    background: radial-gradient(circle, rgba(255, 255, 255, 1) 0%, rgba(105, 105, 105, 1) 100%), var(--color-darck);
    background-blend-mode: overlay;
}
